...
sde2 = manager1.children.create!(name: "sde2 name", email: "sde2@gmail.com", salary: 300000, rating: 4.3, role: sde_role)
sde3 = manager2.children.create!(name: "sde3 name", email: "sde3@gmail.com", salary: 400000, rating: 4.3, role: sde_role)
sde4 = manager2.children.create!(name: "sde4 name", email: "sde4@gmail.com", salary: 500000, rating: 4.3, role: sde_role)
sde5 = manager3.children.create!(name: "sde5 name", email: "sde5@gmail.com", salary: 600000, rating: 4.3, role: sde_role)
sde6 = manager3.children.create!(name: "sde6 name", email: "sde6@gmail.com", salary: 700000, rating: 4.3, role: sde_role)
sde7 = manager4.children.create!(name: "sde7 name", email: "sde7@gmail.com", salary: 800000, rating: 4.3, role: sde_role)
sde8 = manager4.children.create!(name: "sde8 name", email: "sde8@gmail.com", salary: 900000, rating: 4.3, role: sde_role)